...
namespace Ems
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            oDataBuilder.EntitySet<Ems.Models.Emsdb.Employee>("Employees");
            ...
            services.AddControllers().AddOData(opt => { 
              opt.AddRouteComponents("odata/EMSDB", model).Count().Filter().OrderBy().Expand().Select().SetMaxTop(null).TimeZone = TimeZoneInfo.Utc;
            });

            

            services.AddDbContext<Ems.Data.EmsdbContext>(options =>
            {
